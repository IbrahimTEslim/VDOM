...
var renderElem = function renderElem(vNode) {
...
var _default = render;
exports.default = _default;
},{"./createElement":"vdom/createElement.js"}],"vdom/mount.js":[function(require,module,exports) {
"use strict";
...
var diffChildren = function diffChildren(vOldChildren, vNewChildren) {
  var patchChildren = [];
  var _iterator = _createForOfIteratorHelper(zip(vOldChildren, vNewChildren)),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var _step$value = _slicedToArray(_step.value, 2),
        vOldChild = _step$value[0],
        vNewChild = _step$value[1];
  ...
  var _iterator2 = _createForOfIteratorHelper(vNewChildren.slice(vOldChildren.length)),
    _step2;
  try {
  ...
  return function ($parent) {
    var _iterator3 = _createForOfIteratorHelper(zip(patchChildren, $parent.childNodes)),
      _step3;
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        var _step3$value = _slicedToArray(_step3.value, 2),
          _patch = _step3$value[0],
...
var createVApp = function createVApp(count) {
  return (0, _createElement.default)("div", {
    id: "app",
    dataCount: count
  }, [(0, _createElement.default)("input"), String(count), (0, _createElement.default)("img", {
...
var $root = (0, _mount.default)($app, document.getElementById("app"));
